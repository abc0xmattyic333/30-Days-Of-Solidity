<div align="center">
  <h1> 30 Days Of Solidity: Quick Summary Cheatsheet</h1>
...
[<< Day 30](../Day%2030%20-%20Polymorphism/readme.md)

![Cover](./cover.png)

---

## Solidity Quick Summary Cheatsheet

Solidity is an object-oriented, high-level language for implementing smart contracts. Smart contracts are programs which govern the behaviour of accounts within the Ethereum state. It is a statically-typed curly-braces programming language designed for developing smart contracts that run on Ethereum.
